...
if (isset($_POST['add_book'])) {
	...
	$query = "insert into books values(NULL,'$_POST[book_name]','$_POST[book_author]','$_POST[book_category]',$_POST[book_no],$_POST[book_price],$_POST[book_quantity])";
	$query_run = mysqli_query($connection, $query);
	...
	<script type="text/javascript">
							swal({
          title: 'Book added!',
          text: ' Redirectiing to Admin Dashboard!',
          type: 'success'
        }).then(function() {
