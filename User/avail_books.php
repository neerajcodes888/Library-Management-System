...
<head>
	...
	<b>
	<?php echo $_SESSION['name'];?>  Here is the list Of available books in the library. Have a look and take which one you need and download!!!
</b>
</marquee>
</span>
	<br><br>
	<div class="container">
		...
		<br>
		<center><h4><u><b>Searched Book's Details</b></u></h4><br></center>
		<div class="row">
			<div class="col-md-2"></div>
			<div class="col-md-8">
				<form>
					...
					{
						$sql="SELECT * from books,authors where books.author_id=authors.author_id and books.book_name like '%$_POST[search]%'";
						...
						while ($row = mysqli_fetch_assoc($query_run)){
							...
							<td><?php echo $row['book_no'];?></td>
							<td><?php echo $row['quantity'];?></td>
							<td><button class="btn" name=""><a href="request.php?bn=<?php echo $row['book_no']; ?>"" style="color:green">Request</a></button></td>
						</tr>
